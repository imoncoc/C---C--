...
namespace presentation {
    void wellcome()
    {
        int i;
        system("Color 70");
        system("title Basic Bank");
        system("mode con:cols=80 lines=30");
        printf("\n\n\n\n\n\n\n\n\n\n\t\t\t\t");
        char a0[10]="WELCOME",a1[3]="TO",a2[25]="OUR  BANK  PROJECT";
        char *b0,*b1,*b2;
        b0=a0,b1=a1,b2=a2;
...
int main() {
    ...
    clientName.push_back("Sujit");
    clientName.push_back("Mostofa");
    clientName.push_back("Machine");
    clientAmount.push_back(25);
    clientAmount.push_back(50);
    clientAmount.push_back(75);
    clientAmount.push_back(85);
    clientAmount.push_back(96);
    clientAmount.push_back(128);
    clientAmount.push_back(05);
